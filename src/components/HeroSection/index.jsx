          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <p className="w-text fadeInUp" data-wow-delay="0.3s"> DeCerta (Decentralized Certification System) blokzincirde 
belgelerinizi, diplomalarınızı vb. sonsuza kadar güvende tutmak için bir çözümdür. </p>
