                    ...
                    <div className="row">
                      ...
                      <div className="col-12">
                        <div className="group fadeInUp" data-wow-delay="0.5s">
                          <textarea name="mesaj" id="message" required defaultValue={""} />
                          <span className="highlight" />
                          <span className="bar" />
                          <label>Mesaj</label>
                        </div>
                      ...
                      <div className="col-12 text-center fadeInUp" data-wow-delay="0.6s">
                        <button type="submit" className="btn more-btn">MESAJI GÖNDER</button>
                      </div>
                    </div>
                  </form>
                </div>
                  ...
                  <div className="footer-copywrite-info">
                    ...
                    <div className="footer-social-info fadeInUp" data-wow-delay="0.4s">
                      {IcoName && IcoName.map((item , key) => (
                          <a key={key} href={Links[key]}><i className={item.IcoName} aria-hidden="true" /></a>    
                  ...
                  <div key={key} className={item.classBlock}>
                    <div className="contact_info_area d-sm-flex justify-content-between">
                      <div className={item.classInfo} data-wow-delay="0.3s">
                        <h5>{item.title}</h5>
                        <a href="https://tr.linkedin.com/in/b%C3%BC%C5%9Fra-t%C4%B1rkaz-940115193"><p>{item.text1}</p></a>
